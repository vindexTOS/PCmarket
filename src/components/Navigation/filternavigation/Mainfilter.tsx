...
function Mainfilter() {
  ...
  const style = {
    mainDiv: `w-[95%]    h-[100px] max_md:w-[100%] max_md:ml-5 bg-gray-100 rounded-[12px] flex items-center  mdxl:justify-end   justify-between   filtershaddow  gap-5 max_sm:gap-0`,
    dropdown: `w-[220px] h-[50px] max_sm:h-[30px] max_sm:text-[9px] max_sm:w-[90px] max_md:w-[180px] max_md:h-[40px] rounded-[16px] border-[1px] flex items-center justify-between cursor-pointer  `,
  ...
  return (
    <div className={style.mainDiv}>
      ...
      />
      <BsFilter className={style.dropDownFilter} />
